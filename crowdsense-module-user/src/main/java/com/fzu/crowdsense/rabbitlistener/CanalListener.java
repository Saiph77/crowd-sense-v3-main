package com.fzu.crowdsense.rabbitlistener;



import com.fzu.crowdsense.canal.CanalTable;
import com.fzu.crowdsense.canal.MyCanalUtil;
...
public class CanalListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(name = MESSAGE_CANAL_QUEUE),
            exchange = @Exchange(name = CROWD_SENSE_EXCHANGE, type = ExchangeTypes.TOPIC),
